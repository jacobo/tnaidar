...
Object.extend(SiteMap.prototype, {
  ...
  saveExpandedCookie: function() {
	for(i=0; i<sitemap.expandedRows.length; i++)
	{
		if((sitemap.expandedRows[i] + "").indexOf(';') >= 0)
		{
			sitemap.expandedRows[i] = sitemap.expandedRows[i].substring(0, sitemap.expandedRows[i].indexOf(';'));
		}
	}
