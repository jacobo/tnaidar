...
DatetimeToolbocks.prototype = {
  ...
  initialize: function(options) {
    ...
    var d = this.parseDateString(this.options.inputValue);
...
/*
    ...
    html += '<div class="DatetimeToolbocks">\n' +
            ...
            '</div>\n';
*/
	html += '<input value="' + (this.options.inputValue ? this.options.inputValue : '') + '" id=' 
					+ this.options.calendarOptions.inputField + ' name="' + this.options.inputName 
					+ '" size="10" type="text" />\n' +
					'    <img alt="Calendar" id=' + this.options.calendarOptions.button 
						+ ' src="/plugin_assets/datetime_toolbocks/images/icon-calendar.gif" style="cursor: pointer;" />\n' +
        	'  <small><span id=' + this.options.messageField + '></span></small>\n';
